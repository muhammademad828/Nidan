    ...
    <form action="{{ route('admin.slides.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white shadow-sm rounded-xl p-6 border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="subtitle_en" rows="3"
                              class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-nidan-gold focus:ring-2 focus:ring-nidan-gold/20 outline-none transition-all">{{ old('subtitle_en') }}</textarea>
                </div>
                
                <div class="space-y-2">
                    <label class="text-sm font-medium text-gray-700">Subtitle (Arabic)</label>
                    <textarea name="subtitle_ar" rows="3" dir="rtl"
                              class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-nidan-gold focus:ring-2 focus:ring-nidan-gold/20 outline-none transition-all">{{ old('subtitle_ar') }}</textarea>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="button_text_ar" value="{{ old('button_text_ar') }}" dir="rtl"
                           class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-nidan-gold focus:ring-2 focus:ring-nidan-gold/20 outline-none transition-all">
                </div>

                <div class="space-y-2">
                    <label class="text-sm font-medium text-gray-700">WhatsApp Button Text (English)</label>
                    <input type="text" name="secondary_button_text_en" value="{{ old('secondary_button_text_en') }}" placeholder="Contact Us"
                           class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-nidan-gold focus:ring-2 focus:ring-nidan-gold/20 outline-none transition-all">
                </div>
                
                <div class="space-y-2">
                    <label class="text-sm font-medium text-gray-700">WhatsApp Button Text (Arabic)</label>
                    <input type="text" name="secondary_button_text_ar" value="{{ old('secondary_button_text_ar') }}" dir="rtl" placeholder="تواصل معنا"
                           class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-nidan-gold focus:ring-2 focus:ring-nidan-gold/20 outline-none transition-all">
                </div>

                <div class="space-y-2">
                    <label class="text-sm font-medium text-gray-700">Primary Button URL</label>
                    <input type="text" name="button_url" value="{{ old('button_url') }}" list="routes_list" placeholder="/collections"
                           class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-nidan-gold focus:ring-2 focus:ring-nidan-gold/20 outline-none transition-all">
                </div>
            ...
            <div class="mt-6 space-y-4">
                <label class="text-sm font-medium text-gray-700">Media Source</label>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-6 bg-gray-50 rounded-2xl border border-dashed border-gray-300">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Option 2: Upload File (Max 20MB)</label>
